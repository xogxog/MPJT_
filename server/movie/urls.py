...
urlpatterns = [
    ...
    path('movie/<int:movie_id>/like/', views.movie_like),
    path('movie/save_movies/', views.save_movies),
    path('movie/<int:movie_id>/review/', views.create_review), #리뷰생성
    path('movie/review/<int:review_pk>/', views.review_detail),
    path('movie/review/<int:review_pk>/like/', views.review_like),
